              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <Image src="/optimized/neulink-logo.webp" alt="NEULINK" width={48} height={48} className="w-12 h-12 object-contain" />
                    <div>
                  ...
                  <div className="flex items-center gap-4">
                    <Image src="/optimized/foonexus-logo.webp" alt="FOONEXUS" width={48} height={48} className="w-12 h-12 object-contain" />
                    <div>
                  ...
                  <div className="flex items-center gap-4">
                    <Image src="/optimized/lveo-logo.webp" alt="LVEO" width={48} height={48} className="w-12 h-12 object-contain" />
                    <div>
