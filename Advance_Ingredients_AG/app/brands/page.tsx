    ...
    <>
      ...
      <section className="py-16 px-16">
        <div className="container mx-auto max-w-6xl">
          <div className="flex gap-8 mb-8">
            <div className="w-32">
              <Image src="/optimized/neulink-logo.webp" alt="NEULINK" width={128} height={128} className="w-full h-auto object-contain" />
            </div>
      ...
      <section className="bg-[#F8F8F8] py-16 px-16">
        <div className="container mx-auto max-w-6xl">
          <div className="flex gap-8 mb-8">
            <div className="w-32">
              <Image src="/optimized/foonexus-logo.webp" alt="FOONEXUS" width={128} height={128} className="w-full h-auto object-contain" />
            </div>
      ...
      <section className="py-16 px-16">
        <div className="container mx-auto max-w-6xl">
          <div className="flex gap-8 mb-8">
            <div className="w-32">
              <Image src="/optimized/lveo-logo.webp" alt="LVEO" width={128} height={128} className="w-full h-auto object-contain" />
            </div>
